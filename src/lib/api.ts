...
export const adminApi = {
    ...
    activateClientEmploye: (clientId: string, employeeId: string) => apiFetch(`/admin/clients/${clientId}/employes/${employeeId}/activate`, { method: 'POST' }),
    deactivateClientEmploye: (clientId: string, employeeId: string) => apiFetch(`/admin/clients/${clientId}/employes/${employeeId}/deactivate`, { method: 'POST' }),
    resetClientEmployePassword: (clientId: string, employeeId: string) => apiFetch(`/admin/clients/${clientId}/employes/${employeeId}/reset-password`, { method: 'POST' }),
    getClientPlanningSettings: (clientId: string) => apiFetch(`/admin/clients/${clientId}/planning-settings`),
