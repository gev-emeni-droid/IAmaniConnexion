...
CREATE INDEX IF NOT EXISTS idx_event_notes_client_id ON event_notes(client_id);
CREATE INDEX IF NOT EXISTS idx_event_notes_event_id ON event_notes(event_id);
CREATE INDEX IF NOT EXISTS idx_staff_mapping_client_id ON staff_category_mapping(client_id);
CREATE INDEX IF NOT EXISTS idx_staff_mapping_category_id ON staff_category_mapping(staff_category_id);
CREATE INDEX IF NOT EXISTS idx_staff_mapping_employee_id ON staff_category_mapping(employee_id);
CREATE INDEX IF NOT EXISTS idx_job_posts_client_id ON job_posts(client_id);
CREATE INDEX IF NOT EXISTS idx_billing_settings_client_id ON billing_settings(client_id);
CREATE INDEX IF NOT EXISTS idx_employee_documents_client_id ON employee_documents(client_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_collaborators_username_unique ON collaborators(username) WHERE username IS NOT NULL;
